...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initializer()
        {
            ...
            {
                UserName = "allysson-admin",
                Email = "allysson-admin@gmail.com",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Projeto123$").GetAwaiter().GetResult();
            ...
            {
                UserName = "allysson-client",
                Email = "allysson-client@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (34) 12345-6789",
                FirstName = "Allysson",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Projeto123$").GetAwaiter().GetResult();
